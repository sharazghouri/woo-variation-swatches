<?php
	...
	if ( ! function_exists( 'gwp_plugin_deactivate_feedback_dialog' ) ):
		function gwp_plugin_deactivate_feedback_dialog( $plugin_name, $deactivate_reasons ) {
			?>
            <div id="gwp-plugin-deactivate-feedback-dialog-wrapper" style="display: none">
                <form class="feedback-dialog-form" method="post" onsubmit="return false">
                    ...
                    <div class="feedback-dialog-form-buttons">
                        <button class="button button-primary" data-defaultvalue="<?php esc_html_e( 'Submit &amp; Deactivate', 'woo-variation-swatches' ) ?>" data-deactivating="<?php esc_html_e( 'Deactivating...', 'woo-variation-swatches' ) ?>" id="feedback-dialog-form-button-send"><?php esc_html_e( 'Submit &amp; Deactivate', 'woo-variation-swatches' ) ?></button>
